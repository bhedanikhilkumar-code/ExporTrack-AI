        ...
        {trackingData && (
          <div className="grid gap-6 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div className="lg:col-span-3 xl:col-span-4">
               <ShipmentRiskAlert shipmentId={trackingNumber || trackingData.tracking_number || ''} isDelayed={trackingData.delayAlert?.isDelayed} />
            </div>
                     ...
                     <div className="card-premium flex flex-col border-l-4 border-l-purple-500 bg-gradient-to-br from-purple-50/50 to-white dark:from-purple-900/10 dark:to-slate-900">
                        <div className="flex flex-1 items-start justify-between mb-2">
                           <div className="flex items-center gap-2">
                             ...
                             <h3 className="text-[10px] font-bold uppercase tracking-widest text-purple-600 dark:text-purple-400">Neural Prediction</h3>
                           </div>
                           <span className={`text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded ${
                             ...
                             {trackingData.aiEta.confidenceScore}% Reliability
                           </span>
                        </div>
                        <div className="space-y-1">
                          <p className="text-lg font-black text-slate-900 dark:text-white mt-1 leading-none">
                             {new Date(trackingData.aiEta.predictedArrival).toLocaleDateString(undefined, { weekday: 'short', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}
                          </p>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Est. Predicted Delivery</p>
                        </div>
                        {trackingData.delayAlert?.isDelayed && (
                          <p className="text-[10px] font-bold text-rose-500 uppercase flex items-center gap-1 mt-3 pt-2 border-t border-rose-100 dark:border-rose-900/30">
